    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('password', models.CharField(max_length=100, validators=[django.core.validators.RegexValidator('[A-Za-z0-9@#$%^&+=]{8,20}', message='Must have at least one upper case alphabate, one digit, and one special character')])),
